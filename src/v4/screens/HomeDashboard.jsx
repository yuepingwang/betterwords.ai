...
const NEXT_TONES = {
  awaiting: {
    ...
    meta: () => 'no reply yet',
    cta: 'Nudge them ✦',
    art: '/ds-v4/assets/characters/convo-waiting-snail.svg',
    mode: 'followup',
  },
  replied: {
    badge: () => 'THEY REPLIED',
    ...
    cta: 'Help me respond ✦',
    art: '/ds-v4/assets/characters/ctx-sent.svg',
    mode: 'respond',
  },
  draft: {
    ...
    meta: () => 'not sent yet',
    cta: 'Keep drafting ✦',
    art: '/ds-v4/assets/characters/ctx-waiting.svg',
    mode: 'open',
  },
}
          ...
          <DashCard>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ background: 'var(--peri-100)', borderRadius: 8, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 20 }}>
                ...
                <img src="/ds-v4/assets/characters/ctx-sent.svg" alt="" style={{ width: 64, height: 56, objectFit: 'contain', flexShrink: 0 }} />
              </div>
            </div>
          </DashCard>
          ...
          <DashCard>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                  ...
                  {[
                    ...
                    <button key={dir} type="button" aria-label={label} onClick={() => setNextIdx((i) => i + step)} style={{ border: 0, padding: 0, background: 'transparent', cursor: 'pointer', display: 'inline-flex', width: 36, height: 36 }}>
                      <img src={`/ds-v4/assets/glyphs/home-arrow-${dir}.svg`} alt="" style={{ width: 56, height: 56, margin: '-6px -10px -14px -10px' }} />
                    </button>
                  ))}
                </div>
              )}
            ...
            {suggestion ? (
              ...
              <div style={{ background: 'rgba(255, 253, 248, 0.9)', border: '1px solid rgba(255, 255, 255, 0.7)', borderRadius: 22, boxShadow: '0 2px 5px rgba(21, 18, 62, 0.07)', padding: '24px 22px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, textAlign: 'center' }}>
                <img src="/ds-v4/assets/characters/ctx-courage.svg" alt="" style={{ width: 76 }} />
