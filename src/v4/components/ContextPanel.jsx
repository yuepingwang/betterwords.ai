    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '6px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <span
            aria-hidden
            style={{ width: 20, height: 20, backgroundColor: 'var(--ink-700)', WebkitMaskImage: 'url(/ds-v4/assets/glyphs/convo-caret.svg)', maskImage: 'url(/ds-v4/assets/glyphs/convo-caret.svg)', WebkitMaskRepeat: 'no-repeat', maskRepeat: 'no-repeat', WebkitMaskPosition: 'center', maskPosition: 'center' }}
          />
