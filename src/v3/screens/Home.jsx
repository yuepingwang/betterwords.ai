...
export default function Home() {
  ...
  return (
    ...
    // wrapper in V3App so it runs the full viewport height; this main just
    // anchors the floating characters.
    <main style={{ position: 'relative' }}>
      {/* ambient critters, floating gently (hidden on small screens) */}
      <img className="bw-float" src="/ds-v3/assets/characters/ctx-courage.svg" style={{ width: 116, bottom: 16, left: '4%' }} alt="" />
      <img className="bw-float f2" src="/ds-v3/assets/characters/tool-landing.svg" style={{ width: 108, top: 108, right: '8%' }} alt="" />
      <img className="bw-float f3" src="/ds-v3/assets/characters/spark.svg" style={{ width: 52, top: 140, left: '13%' }} alt="" />
            ...
            return (
              ...
              >
                <div className="bw-home-art" style={{ background: tone.chip }}>
                  <img src={`/ds-v3/assets/characters/${SCENARIO_ART[id]}.svg`} alt="" />
                </div>
