    ...
    <div style={{ position: 'relative', background: 'var(--bg-base)', color: 'var(--text-body)', fontFamily: 'var(--font-sans)' }}>
      ...
      <section className="grad-daybreak" style={{ marginTop: -68, paddingTop: 68 }}>
        <div className="lp2-hero">
          <img className="lp2-float d1" src="/ds-v3/assets/characters/ctx-sent.svg" style={{ width: 118, top: 64, right: '12%' }} alt="" />
          <img className="lp2-float d2" src="/ds-v3/assets/characters/ctx-waiting.svg" style={{ width: 112, bottom: 44, left: '9%' }} alt="" />
          <img className="lp2-float d3" src="/ds-v3/assets/characters/spark.svg" style={{ width: 60, top: 120, left: '16%' }} alt="" />
          ...
          <div className="wrap" style={{ paddingTop: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginTop: 52, flexWrap: 'wrap', justifyContent: 'center' }}>
              <Button variant="gradient-warm" size="lg" iconRight={<img src="/ds-v3/assets/glyphs/logo-star-white.svg" alt="" width={13} height={13} style={{ display: 'block', transform: 'translateY(2px)' }} />} onClick={start} style={{ height: 50, padding: '0 28px', fontSize: 16 }}>Start writing free</Button>
            ...
            {SCENARIO_IDS.map((id) => {
              ...
              return (
                <Card key={id} className="adv-card-hover bw-home-card" onClick={() => onStart(id)} style={{ '--card-edge': SCENARIO_EDGE[id], display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '40px 28px', cursor: 'pointer' }}>
                  <img src={`/ds-v3/assets/characters/${SCENARIO_ART[id]}.svg`} alt="" style={{ width: 128, height: 110, objectFit: 'contain', margin: '0 0 20px' }} />
      ...
      <section className="section night bg-night-sky">
        <div className="wrap center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ marginTop: 30 }}>
            <Button variant="spark" size="lg" iconRight={<img src="/ds-v3/assets/glyphs/logo-star-white.svg" alt="" width={13} height={13} style={{ display: 'block', transform: 'translateY(2px)' }} />} onClick={start}>Compose a message</Button>
          </div>
          ...
          <div className="lp2-stack">
            {LETTERS.map((d, id) => {
              ...
              return (
                ...
                >
                  <span className="lp2-stamp"><img src={`/ds-v3/assets/characters/${d.ill}.svg`} alt="" /></span>
