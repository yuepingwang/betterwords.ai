...
function reducer(state, action) {
  switch (action.type) {
    ...
    case 'GO_LANDING':
      return { ...state, screen: 'landing', scenarioId: null, clarifyStep: 0, answers: {}, strategies: null, draftedAnswers: null, sent: false, threadId: null }
    case 'RESTART':
      return { ...state, screen: 'home', scenarioId: null, clarifyStep: 0, answers: {}, strategies: null, draftedAnswers: null, sent: false, threadId: null }
    case 'START_SCENARIO':
      return { ...state, scenarioId: action.scenarioId, screen: 'clarify', clarifyStep: 0, answers: {}, strategies: null, draftedAnswers: null, threadId: null }
    case 'SET_THREAD':
...
// Dev deep-link: `?v=3&screen=editor&scenario=rights[&idx=1]` boots straight
